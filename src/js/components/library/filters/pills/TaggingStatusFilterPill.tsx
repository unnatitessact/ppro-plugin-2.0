...
export const TaggingStatusFilterPill = ({ filter }: TaggingStatusFilterPillProps) => {
        ...
        <Popover isOpen={!value}>
          ...
          <PopoverContent>
            ...
            >
              ...
              <ListboxItem startContent={<TaggingStatusIcon status="completed" />} key="completed">
                Completed
              </ListboxItem>
            </Listbox>
          </PopoverContent>
      ...
      {value && (
        <Dropdown>
          ...
          >
            ...
            <DropdownItem startContent={<TaggingStatusIcon status="completed" />} key="completed">
              Completed
            </DropdownItem>
          </DropdownMenu>
        </Dropdown>
