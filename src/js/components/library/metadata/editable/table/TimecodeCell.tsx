...
export const TimecodeCell = ({ fieldId, label, value, categoryId, rowId }: TimecodeCellProps) => {
        ...
        <form onSubmit={onSubmit} className={cn('p-2', 'flex flex-col gap-2', 'rounded-2xl')}>
          ...
          <div className="flex flex-col gap-4">
            <div className="flex flex-col gap-1">
              <TimecodeInput value={newValue} onChange={setNewValue} />
              <p
                className={cn(
