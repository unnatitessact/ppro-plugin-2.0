...
import { TechnicalMetadataItem } from '@/components/library/metadata/TechnicalMetadataItem';
      ...
      <ScrollShadow className="h-full w-full p-4" showTopBorder={false}>
        <div className="flex flex-col gap-6">
          <div className="flex flex-col gap-2">
            ...
            />
            <TechnicalMetadataItem label="Codec" value={<p>{data.codec || 'N/A'}</p>} />
            <TechnicalMetadataItem
              label="Uploaded on"
            ...
            {Object.entries(data.technical_metadata).map(([key, value]) => {
              ...
              return <TechnicalMetadataItem key={key} label={key} value={<p>{value}</p>} />;
            })}
          </div>
        </div>
      </ScrollShadow>
