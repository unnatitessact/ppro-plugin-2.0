...
//   const { selectedItems, clearSelectedItems, selectedClipboardAction, setSelectedClipboardAction } =
//     useLibraryStore();
...
//           {selectedClipboardAction === 'copy' || selectedClipboardAction === 'cut' ? (
//             <>
//               <Button
//                 color="primary"
...
//         isOpen={isDeleteModalOpen}
//         onOpenChange={onDeleteModalOpenChange}
//         title={`Deleting ${selectedItems.length} ${pluralize('file', selectedItems.length)}`}
