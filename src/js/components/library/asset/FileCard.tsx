...
} from "@/components/library/asset/ResourceCard";
...
import { IconThumbnail } from "@/components/library/thumbnail/IconThumbnail";

import { FileStatus, VersionStackAsset } from "@/api-integration/types/library";
...
interface FileCardProps extends ResourceSpecificCardProps {
  fileSize: number;
...
export const FileCard = ({
  ...
  const isEditorDraft = fileExtension === ".tdraft";
  const isDocument = fileExtension === ".tscript";
  const isCanvas = fileExtension === ".tboard";
