...
// import { LiveShapePreview, RoomProvider, useEventListener } from '@/liveblocks.config';
...
//         settings?.local &&
//         settings?.browser &&
//         (platform.todesktop.isDesktopApp() || Notification.permission === 'granted')
//       ) {
...
//     return notifications?.find((notification) => notification.id === selectedNotification);
...
//                     hideSelectedIcon
//                     selectedKeys={
//                       selectedNotification ? new Set([selectedNotification]) : new Set([])
//                     }
...
//         cursor: null,
//         currentShape: defaultShape(selectedShape, selectedColor) as LiveShapePreview,
...
import { Bell } from "@tessact/icons";

export const NotificationBellWithRoomProvider = () => {
  return (
    <Badge
      placement="top-right"
      color="danger"
