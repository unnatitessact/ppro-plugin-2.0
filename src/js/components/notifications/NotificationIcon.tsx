...
import { StepStatusIcons } from "@/components/workflow/StatusPill";
...
const NotificationMappedIcon = ({
  data,
}: {
  data: NotificationRoomEventData;
}) => {
  const size = 20;
  ...
  if (
    ...
    const newStatus = data.metadata.new_status
      .toLowerCase()
      .split(" ")
      .join("_") as FileStatus;
