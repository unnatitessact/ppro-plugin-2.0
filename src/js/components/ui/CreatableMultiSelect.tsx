...
interface CreatableMultiSelectProps extends CreatableProps<Option, true, GroupBase<Option>> {}
  ...
  return (
    <Select
      ...
      classNames={{
        ...
        multiValue: () => 'bg-default-200 border border-default-300 rounded-md px-1 py-0.5 text-sm',
